...
void test_validate_my_username()
{
     ...
     */
    const char* fixed_name = my_username();
    const char* returned_name = malloc_username_from_conf_file();
    TEST_ASSERT_EQUAL_STRING_MESSAGE(fixed_name, returned_name, "names not matching");
